<?php /* Smarty version Smarty-3.1.6, created on 2018-12-19 09:54:52
         compiled from "D:/xampp/htdocs/Admin/View\TravelSet\addWashShop.html" */ ?>
<?php /*%%SmartyHeaderCode:75365bc041f25fc5c1-82915834%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '210c657cb53ff5a4a3a206d6d3a2670bf44c23f4' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\TravelSet\\addWashShop.html',
      1 => 1543804936,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '75365bc041f25fc5c1-82915834',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bc041f270218',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc041f270218')) {function content_5bc041f270218($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>新增车辆</title>
    ...
    <div class="page-content">
        <div>
            <div class="portlet light">
                ...
                <form class="form-horizontal" role="form" action="/index.php/Admin/TravelSet/addWashShopDo" method="post" id="addCarForm">
                    <div class="form-body">

                        <div class="form-group col-md-6">
                            <label class="col-md-4 control-label">服务单位名称</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="服务单位名称" name="shop_name" id="shop_name">
...
<script>
    ...
    $("#addCarForm").submit(function () {
        ...
        if(isE($("#shop_name").val())){ toastr.error('服务单位名称不得为空！');  $("#shop_name").focus();return false; }
