<?php /* Smarty version Smarty-3.1.6, created on 2018-10-15 10:52:54
         compiled from "/var/www/yxcarnew/Home/View/Company/allTravels.html" */ ?>
<?php /*%%SmartyHeaderCode:5170526555bc4010683ad70-13937383%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9ae4ee13642194a80bae52e719fe14cfe99392c' => 
    array (
      0 => '/var/www/yxcarnew/Home/View/Company/allTravels.html',
      1 => 1537241010,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5170526555bc4010683ad70-13937383',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bc4010696102',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc4010696102')) {function content_5bc4010696102($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">出行审核</span>
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <form action="/index.php/Home/Company/toExcel" method="post" target="_blank">
...
<script>
    ...
    //重新提交
    function fiflt() {
        var dttable = $('#waitReview').dataTable();
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "travel_reason","defaultContent": "<i>暂无</i>","orderable":false  }
                ],
                "columnDefs": [
        ...
        $('#waitReview tbody').on( 'click', 'td .agreeTravel', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Home/Company/reviewTravelDo.html",
                            {
                                id:TravelId,
                                type:1
                            },
