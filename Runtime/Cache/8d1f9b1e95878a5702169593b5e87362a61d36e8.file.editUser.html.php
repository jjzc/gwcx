<?php /* Smarty version Smarty-3.1.6, created on 2018-10-16 11:15:30
         compiled from "/var/www/yxcarnew/Admin/View/Company/editUser.html" */ ?>
<?php /*%%SmartyHeaderCode:4650495045bc557d2d89450-03662760%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8d1f9b1e95878a5702169593b5e87362a61d36e8' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Company/editUser.html',
      1 => 1527562500,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4650495045bc557d2d89450-03662760',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bc557d2e502d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc557d2e502d')) {function content_5bc557d2e502d($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>新增用户</title>
    ...
    <div class="page-content">
        <div>
            <div class="portlet light">
                ...
                <form class="form-horizontal" role="form" action="/index.php/Admin/Company/editUserDo" method="post" id="addDriverForm">
...
" <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['user']->value['user_company']){?>selected = "selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['company_name'];?>
</option>
                                    <?php } ?>
                                </select>
...
">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="姓名" name="user_name" id="user_name" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['user_name'];?>
">
                                <span style="color: #FF0000;">*</span>
                            </div>
                        </div>
...
">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="邮箱"  name="user_email" id="user_email" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['user_email'];?>
">
                            </div>
                        </div>
