<?php /* Smarty version Smarty-3.1.6, created on 2018-12-13 09:19:05
         compiled from "D:/xampp/htdocs/Admin/View\UserCenter\userList.html" */ ?>
<?php /*%%SmartyHeaderCode:322395bd187de856c93-83989981%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9529b262cb2922ccf46264af52873363cb92d347' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\UserCenter\\userList.html',
      1 => 1543804938,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '322395bd187de856c93-83989981',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bd187df02924',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bd187df02924')) {function content_5bd187df02924($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                    ...
                    <li class="nav-item start active open">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item start  active open">
                                <a href="/index.php/Admin/UserCenter/userList" class="nav-link ">
                                    <i class="icon-bulb"></i>
                            ...
                            <li class="nav-item start ">
                                <a href="/index.php/Admin/UserCenter/groupList" class="nav-link ">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部用户</span>
                                </div>
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCar()"> 新增用户
...
<script>
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "group_name","defaultContent": "<i>暂无</i>","orderable":false },
                    { "data": "error_num","defaultContent": "<i>暂无</i>"  ,"render":function (data,type,full,meta) {
                            if(data>=5){
                                return "<span style='color: #FF0000;'>已锁定</span>";
                            }else{
                                return"正常";
                            }
                        }},

                    { "data": "id","defaultContent": "<i></i>","orderable":false ,"render":function (data,type,full,meta) {
                        if (data>1){
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/UserCenter/addUser'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/UserCenter/editUser/id/'+id
            });
        })
        ...
        $('#allCars tbody').on( 'click', 'td .delCar', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/UserCenter/delUser.html",
                            {
                                id:carId
                            },
                            function(data){
...
<script id="carTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            ...
            <li>
                <a href="javascript:;" class="delCar" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-file-pdf-o"></i> 删除用户 </a>
            </li>
        </ul>
    </div>
</script>
