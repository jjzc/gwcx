<?php /* Smarty version Smarty-3.1.6, created on 2018-12-19 16:30:34
         compiled from "D:/xampp/htdocs/Admin/View\Car\insuranceRecord.html" */ ?>
<?php /*%%SmartyHeaderCode:19225bbf094768ea67-86374755%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f53bb54ce18f037020034476206a8806ca202eea' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Car\\insuranceRecord.html',
      1 => 1545201332,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '19225bbf094768ea67-86374755',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bbf0947d8fb8',
  'variables' => 
  array (
    'carLeft1' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_5bbf0947d8fb8')) {function content_5bbf0947d8fb8($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                                ...
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php if (in_array("/index.php/Admin/Car/addInsuranceRecord",$_SESSION['allUrls'])){?>
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCar()"> 新增年检保险记录
							...
							<div class="portlet-body">
                                <form action="/index.php/Admin/Car/insuranceRecordToExcel" method="post" target="_blank">
...
" ><?php echo $_smarty_tpl->tpl_vars['v']->value['car_num'];?>
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="allCars">
                                    ...
                                    <tr><th class="all"colspan="8" style="text-align: center; color: red">总费用：<span id="total_cost">0.00</span></th></tr>
                                    </thead>
                                    <tbody>
...
<script>
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "effect_time","defaultContent": "<i>暂无</i>","render":function (data,type,full,meta) {
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }
                        } },
                    { "data": "expire_time","defaultContent": "<i>暂无</i>","render":function (data,type,full,meta) {
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }
                        } },
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/Car/addInsuranceRecord'
        });
    }
	...
	$('.form_datetime').datetimepicker({
        ...
        $('tbody').on( 'click', 'td .editInsuranceRecord', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Car/addInsuranceRecord/id/'+id
            });
        });
        ...
        $('#allCars tbody').on( 'click', 'td .delCar', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/Car/delInsuranceRecord.html",
                            {
                                id:carId
                            },
                            function(data){
...
<script id="carTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            <?php if (in_array("/index.php/Admin/Car/editInsuranceRecord",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="editInsuranceRecord" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-print"></i> 查看 / 修改 </a>
            </li>
            <?php }?>
            <?php if (in_array("/index.php/Admin/Car/delInsuranceRecord",$_SESSION['allUrls'])){?>
            <li>
