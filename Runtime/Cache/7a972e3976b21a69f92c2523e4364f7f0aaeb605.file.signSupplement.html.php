<?php /* Smarty version Smarty-3.1.6, created on 2018-10-15 15:08:07
         compiled from "/var/www/yxcarnew/Home/View/Travel/signSupplement.html" */ ?>
<?php /*%%SmartyHeaderCode:13928847255bc43cd7d6d532-43065643%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7a972e3976b21a69f92c2523e4364f7f0aaeb605' => 
    array (
      0 => '/var/www/yxcarnew/Home/View/Travel/signSupplement.html',
      1 => 1537241037,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13928847255bc43cd7d6d532-43065643',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bc43cd801802',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc43cd801802')) {function content_5bc43cd801802($_smarty_tpl) {?><!DOCTYPE html>
                    ...
                    <div class="col-md-12">
                        <div class="portlet light ">
                            <div class="portlet-body form">
                                <form class="form-horizontal" role="form" action="/index.php/Home/Travel/signSupplementDo" method="post" id="addCarForm">
...
" <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['user']->value['id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['user_name'];?>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">出车时间</label>
                                            <div class="col-md-10">
                                                <div class="input-group date form_datetime input-medium" data-date="" data-date-format="yyyy-mm-dd hh:ii" data-link-field="start_car_time">
                                                    <input name="start_car_time" id="start_car_time" class="form-control" size="16" type="text" value="" readonly>
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">结束用车时间</label>
                                            <div class="col-md-10">
                                                <div class="input-group date form_datetime input-medium" data-date="" data-date-format="yyyy-mm-dd hh:ii" data-link-field="end_use_car_time">
                                                    <input name="end_use_car_time" id="end_use_car_time" class="form-control" size="16" type="text" value="" readonly>
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                                </div>
                                            </div>
...
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
                                                    <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['pay_name'];?>
"><?php echo $_smarty_tpl->tpl_vars['v']->value['pay_name'];?>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">开始公里数</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control input-inline input-medium" placeholder="开始公里数，单位公里" name="start_kilometers" id="start_kilometers" >
                                            </div>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">结束公里数</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control input-inline input-medium" placeholder="结束公里数，单位公里" name="end_kilometers" id="end_kilometers" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control input-inline input-medium" placeholder="行驶里程，单位公里" name="mileage" id="mileage" >
                                            </div>
                                        </div>


                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">司机</label>
                                            <div class="col-md-10">
                                                <select class="form-control input-inline input-medium" name="driver_id"  id="driver_id">
                                                    <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
...
?>
                                                    <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" data-isdx="<?php echo $_smarty_tpl->tpl_vars['v']->value['is_dx'];?>
"><?php echo $_smarty_tpl->tpl_vars['v']->value['driver_name'];?>
  <?php if ($_smarty_tpl->tpl_vars['v']->value['is_dx']=="1"){?>(定向)<?php }?></option>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">车辆</label>
                                            <div class="col-md-10">
                                                <select class="form-control input-inline input-medium" name="car_id"  id="car_id">
                                                    <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['car_num'];?>
 <?php if ($_smarty_tpl->tpl_vars['v']->value['is_dx']=="1"){?>(定向)<?php }?></option>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">出行服务费</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">路桥费</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">司机住宿补贴</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">超时费</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">超公里费</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="col-md-2 control-label">其他费用</label>
                                            <div class="col-md-10">
                                    ...
                                    <div class="form-actions col-md-12">
                                        <div class="row">
                                            <div class="col-md-offset-5 col-md-7">
                                                <button type="submit" class="btn green" >确认补单</button>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    $("#addCarForm").submit(function () {
        ...
        if(isE($("#search-text2").val())||isE($("#from_place_lat2").val())){ toastr.error('目的地点不得为空！');  $("#search-text2").focus();return false; }
        ...
        if(isE($("#start_car_time").val())){ toastr.error('出车时间不得为空！');  $("#start_car_time").focus();return false; }
        if(isE($("#end_use_car_time").val())){ toastr.error('结束用车时间不得为空！');  $("#end_use_car_time").focus();return false; }
        ...
        if(isE($("#start_kilometers").val())){ toastr.error('开始公里数不得为空！');  $("#start_kilometers").focus();return false; }
        if(isNaN($("#start_kilometers").val())){ toastr.error('开始公里数只能为数字！');  $("#start_kilometers").focus();return false; }

        if(isE($("#end_kilometers").val())){ toastr.error('结束公里数不得为空！');  $("#end_kilometers").focus();return false; }
        if(isNaN($("#end_kilometers").val())){ toastr.error('结束公里数只能为数字！');  $("#end_kilometers").focus();return false; }

        if(isE($("#mileage").val())){ toastr.error('行驶里程不得为空！');  $("#mileage").focus();return false; }
        if(isNaN($("#mileage").val())){ toastr.error('行驶里程只能为数字！');  $("#mileage").focus();return false; }


        if(isE($("#fees_sum").val())){
            $("#fees_sum").val(0);
        }else{
            if(isNaN($("#fees_sum").val())){ toastr.error('路桥费只能为数字！');  $("#fees_sum").focus();return false; }
        }

        if(isE($("#parking_rate_sum").val())){
            $("#parking_rate_sum").val(0);
        }else{
            if(isNaN($("#parking_rate_sum").val())){ toastr.error('停车费只能为数字！');  $("#parking_rate_sum").focus();return false; }
        }

        if(isE($("#service_charge").val())){
            $("#service_charge").val(0);
        }else{
            if(isNaN($("#service_charge").val())){ toastr.error('出行服务费只能为数字！');  $("#service_charge").focus();return false; }
        }

        if(isE($("#driver_cost").val())){
            $("#driver_cost").val(0);
        }else{
            if(isNaN($("#driver_cost").val())){ toastr.error('司机住宿补贴只能为数字！');  $("#driver_cost").focus();return false; }
        }

        if(isE($("#over_time_cost").val())){
            $("#over_time_cost").val(0);
        }else{
            if(isNaN($("#over_time_cost").val())){ toastr.error('超时费只能为数字！');  $("#over_time_cost").focus();return false; }
        }

        if(isE($("#over_mileage_cost").val())){
            $("#over_mileage_cost").val(0);
        }else{
            if(isNaN($("#over_mileage_cost").val())){ toastr.error('超公里费只能为数字！');  $("#over_mileage_cost").focus();return false; }
        }

        if(isE($("#else_cost").val())){
            $("#else_cost").val(0);
        }else{
            if(isNaN($("#else_cost").val())){ toastr.error('其他花费只能为数字！');  $("#else_cost").focus();return false; }
        }
        ...
        //当这个单位没有定向车辆时，不得选择定向司机与车辆
        if($("#is_dx").length>0){
            //没有选择定向车辆
            if($("#is_dx").val()==0){
                var is_dxcar=$("#car_id").find("option:selected").attr("data-isdx");
                var is_dxdriver=$("#driver_id").find("option:selected").attr("data-isdx");

                if(is_dxcar==1||is_dxdriver==1){
                    toastr.error('未选择定向出行，不得选取定向司机与车辆');  $("#else_cost").focus();return false;
                }
            }
        }else{
            //没有定向车辆
            ...
            if(is_dxcar==1||is_dxdriver==1){
                toastr.error('本单位没有定向车辆，不得选择定向出行');  $("#else_cost").focus();return false;
            }
        }
        ...
        $(this).ajaxSubmit(function (data) {
            if(data.code==1){
                ...
                setTimeout("window.location.href='/index.php/Home/Travel/mySupplement'",2500);
            }else{
