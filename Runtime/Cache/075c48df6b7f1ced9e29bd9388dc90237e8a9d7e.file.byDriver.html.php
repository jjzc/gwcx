<?php /* Smarty version Smarty-3.1.6, created on 2018-11-29 15:31:38
         compiled from "D:/xampp/htdocs/Admin/View\Report\byDriver.html" */ ?>
<?php /*%%SmartyHeaderCode:156635b99cf5c9394d1-99067424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '075c48df6b7f1ced9e29bd9388dc90237e8a9d7e' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Report\\byDriver.html',
      1 => 1543476693,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156635b99cf5c9394d1-99067424',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5b99cf5cc0047',
  'variables' => 
  array (
    'startTime' => 0,
    'endTime' => 0,
...
<?php if ($_valid && !is_callable('content_5b99cf5cc0047')) {function content_5b99cf5cc0047($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
...
" placeholder="结束时间" readonly style="width: 100px">
                                    ...
                                    <div class="form-group" style="width: 160px; float: left; margin-right: 8px;">
                                        <select name="driver" class="form-control"  onchange="" id="driver">
                                            <option value="0">司机(不限)</option>
                                            <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['driversall']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value){
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
                                            <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['drivername']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['driver_name'];?>
</option>
                                            <?php } ?>
                                        </select>
                                    </div>
                            ...
                            <div class="portlet-body">
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                                    <tr>
                                        <td height="40" colspan="10" style="font-size:18px; text-align:center; line-height:40px;">公务用车平台车辆用车统计报表</td>
                                    </tr>
                                    <tr>
                                        <td height="30" colspan="10" style="font-size:16px; text-align:center; line-height:30px;">开起始时间：<?php echo $_smarty_tpl->tpl_vars['startTime']->value;?>
...
?>
                                    ...
                                    <tr class="trrrrr">
                                        <td nowrap><?php echo $_smarty_tpl->tpl_vars['v']->value['driver_name'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['driver_phone'];?>
</td>
...
<?php $_smarty_tpl->tpl_vars['totle_ratenum'] = new Smarty_variable($_smarty_tpl->tpl_vars['totle_ratenum']->value+$_smarty_tpl->tpl_vars['v']->value['totle_rate'], null, 0);?></td>
                                        <td nowrap><?php echo $_smarty_tpl->tpl_vars['v']->value['service_charge']+$_smarty_tpl->tpl_vars['v']->value['else_cost']+$_smarty_tpl->tpl_vars['v']->value['totle_rate'];?>
</td>
                                    </tr>
                                    <?php } ?>
                                    ...
                                    <tr class="trrrrr">
                                        ...
                                        <td nowrap><?php echo $_smarty_tpl->tpl_vars['service_chargenum']->value+$_smarty_tpl->tpl_vars['costnum']->value+$_smarty_tpl->tpl_vars['totle_ratenum']->value;?>
</td>
                                    </tr>
