<?php /* Smarty version Smarty-3.1.6, created on 2018-10-19 11:23:30
         compiled from "/var/www/yxcarnew/Admin/View/Company/allUsers.html" */ ?>
<?php /*%%SmartyHeaderCode:18417800595bbec5ca710a75-65398721%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca9c3787e0cda47545ce48a063b9f9f7e453f7e6' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Company/allUsers.html',
      1 => 1539832968,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18417800595bbec5ca710a75-65398721',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bbec5ca82b90',
  'variables' => 
  array (
    'companyLeft1' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_5bbec5ca82b90')) {function content_5bbec5ca82b90($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    ...
                                                    <?php if (in_array("/index.php/Admin/Company/addUser",$_SESSION['allUrls'])){?>
...
<script>
    ...
    //删选操作
    function fiflt() {
        var dttable = $('#allCompanys').dataTable();
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewDriver', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Company/editUser/id/'+id
            });
        })
...
<script id="driverTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            <?php if (in_array("/index.php/Admin/Company/editUser",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="viewDriver" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-print"></i> 查看 / 修改 </a>
            </li>
            <?php }?>
            <?php if (in_array("/index.php/Admin/Company/delUser",$_SESSION['allUrls'])){?>
            <li>
