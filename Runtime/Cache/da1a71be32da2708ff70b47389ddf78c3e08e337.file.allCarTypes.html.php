<?php /* Smarty version Smarty-3.1.6, created on 2018-10-11 17:50:56
         compiled from "D:/xampp/htdocs/Admin/View\Car\allCarTypes.html" */ ?>
<?php /*%%SmartyHeaderCode:279065bbf1d00361440-94528682%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da1a71be32da2708ff70b47389ddf78c3e08e337' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Car\\allCarTypes.html',
      1 => 1529922014,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '279065bbf1d00361440-94528682',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbf1d00d0628',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbf1d00d0628')) {function content_5bbf1d00d0628($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部车辆类型</span>
                                </div>
                                <div class="tools"></div>
                            </div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="btn-group">
                                                <?php if (in_array("/index.php/Admin/Car/addCarType",$_SESSION['allUrls'])){?>
                                                <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCarType()"> 新增类型
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="allCarTypes">
                                    <thead>
                                    <tr>
...
<script>
    var TableDatatablesResponsive = function () {
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    { "data": "type_name","defaultContent": "<i>暂无</i>" },
    ...
    function openAddCarType(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/Car/addCarType'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        //注册查看点击事件
        $('tbody').on( 'click', 'td .viewCarType', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Car/editCarType/id/'+id
            });
        })
...
<script id="carTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            <?php if (in_array("/index.php/Admin/Car/editCarType",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="viewCarType" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-print"></i> 查看 / 修改 </a>
            </li>
            <?php }?>
        </ul>
    </div>
