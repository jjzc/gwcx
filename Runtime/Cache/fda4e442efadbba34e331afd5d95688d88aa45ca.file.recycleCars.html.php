<?php /* Smarty version Smarty-3.1.6, created on 2018-11-30 09:26:06
         compiled from "D:/xampp/htdocs/Admin/View\Car\recycleCars.html" */ ?>
<?php /*%%SmartyHeaderCode:131395c0091ae681f13-23534377%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fda4e442efadbba34e331afd5d95688d88aa45ca' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Car\\recycleCars.html',
      1 => 1529915586,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '131395c0091ae681f13-23534377',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c0091af030e2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c0091af030e2')) {function content_5c0091af030e2($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="recycleCars">
                                    <thead>
                                    <tr>
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Car/viewCar/id/'+id
            });
        })
