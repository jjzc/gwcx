<?php /* Smarty version Smarty-3.1.6, created on 2018-10-12 14:40:35
         compiled from "D:/xampp/htdocs/Admin/View\TravelSet\addOilShop.html" */ ?>
<?php /*%%SmartyHeaderCode:50435bc041e304fb43-87187338%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '127b6a65afd76b2814bc0db70e66445e7dbbcaba' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\TravelSet\\addOilShop.html',
      1 => 1528215994,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '50435bc041e304fb43-87187338',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bc041e317c81',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc041e317c81')) {function content_5bc041e317c81($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>新增车辆</title>
    ...
    <div class="page-content">
        <div>
            <div class="portlet light">
                ...
                <form class="form-horizontal" role="form" action="/index.php/Admin/TravelSet/addOilShopDo" method="post" id="addCarForm">
                    <div class="form-body">

                        <div class="form-group col-md-6">
                            <label class="col-md-4 control-label">服务单位名称</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="服务单位名称" name="oil_name" id="oil_name">
...
<script>
    ...
    $("#addCarForm").submit(function () {
        ...
        if(isE($("#oil_name").val())){ toastr.error('服务单位名称不得为空！');  $("#oil_name").focus();return false; }
