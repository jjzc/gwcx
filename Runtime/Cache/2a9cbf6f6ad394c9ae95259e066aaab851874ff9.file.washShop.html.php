<?php /* Smarty version Smarty-3.1.6, created on 2018-12-19 09:54:49
         compiled from "D:/xampp/htdocs/Admin/View\TravelSet\washShop.html" */ ?>
<?php /*%%SmartyHeaderCode:314695bc041ce54c561-20503507%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a9cbf6f6ad394c9ae95259e066aaab851874ff9' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\TravelSet\\washShop.html',
      1 => 1543804938,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '314695bc041ce54c561-20503507',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bc041cea7c8a',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc041cea7c8a')) {function content_5bc041cea7c8a($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部洗车服务单位</span>
                                </div>
                                <div class="tools">
...
<script>
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/TravelSet/addWashShop'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/TravelSet/editWashShop/id/'+id
            });
        })
        ...
        $('#allCars tbody').on( 'click', 'td .delCar', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/TravelSet/delWashShopDo.html",
                            {
                                id:carId
                            },
                            function(data){
