<?php /* Smarty version Smarty-3.1.6, created on 2018-12-13 14:51:18
         compiled from "D:/xampp/htdocs/Admin/View\UserCenter\groupList.html" */ ?>
<?php /*%%SmartyHeaderCode:44005c120166347dd8-99575813%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3306c48b2b3ceecf869e932bb2a40ec76178a9ee' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\UserCenter\\groupList.html',
      1 => 1543804938,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '44005c120166347dd8-99575813',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5c12016677254',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c12016677254')) {function content_5c12016677254($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部分组</span>
                                </div>
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCar()"> 新增分组
...
<script>
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "group_name","defaultContent": "<i>暂无</i>" },
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/UserCenter/addGroup'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/UserCenter/editGroup/id/'+id
            });
        })
