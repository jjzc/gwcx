<?php /* Smarty version Smarty-3.1.6, created on 2018-10-11 16:26:04
         compiled from "/var/www/yxcarnew/Admin/View/Car/allCars.html" */ ?>
<?php /*%%SmartyHeaderCode:5306793565bbf091c55da78-32427055%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ad034f4ed429272b638b8283c550ad78b94ff95' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Car/allCars.html',
      1 => 1537240546,
      2 => 'file',
    ),
    '40d94735bde748414341dbccee4af493fd029932' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Car/template.html',
      1 => 1529915360,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5306793565bbf091c55da78-32427055',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbf091c69dce',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbf091c69dce')) {function content_5bbf091c69dce($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部车辆</span>
                                </div>
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php if (in_array("/index.php/Admin/Car/addCar",$_SESSION['allUrls'])){?>
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCar()"> 新增车辆
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="allCars">
                                    ...
                                    <tr>
                                        ...
                                        <th class="all">编号</th>
                                        <th class="all">车牌号码</th>
                                        <th class="all">车辆类型</th>
                                        <th class="all">车辆性质</th>
                                        <th class="all">车辆名称</th>
                                        <th class="all">座位数</th>
                                        <th class="all">出行里程数</th>
                                        <th class="all">是否定向</th>
                                        <th class="all">状态</th>
                                        <th class="all" width="40">操作</th>

                                        <!--隐藏内容-->
                                        <th class="none">原属单位</th>
                                        <th class="none">现属单位</th>
                                        <th class="none">交强险到期</th>
                                        <th class="none">商业险到期</th>
                                    </tr>
                                    </thead>
                                    <tbody>
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "number","defaultContent": "<i>暂无</i>" },
                    { "data": "car_num","defaultContent": "<i>暂无</i>" },
                    { "data": "carTypeName","defaultContent": "<i>暂无</i>" },
                    { "data": "is_law_car" ,"defaultContent": "<i>暂无</i>","render":function(data,type,full,meta){
                            if(data==1){
                                return "执法车";
                            }else{
                                return "自有车辆";
                    ...
                    { "data": "car_name","defaultContent": "<i>暂无</i>" },
                    { "data": "seat_num","defaultContent": "<i>暂无</i>" },
                    { "data": "countMaintain","defaultContent": "<i>暂无</i>","orderable":false },
                    ...
                    { "data": "old_company","defaultContent": "<i>暂无</i>" },
                    { "data": "new_company","defaultContent": "<i>暂无</i>" },
                    { "data": "compulsory_insurance_time","defaultContent": "<i>暂无</i>" ,"render":function(data,type,full,meta){
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }

                        }},
                    { "data": "commercial_insurance_time","defaultContent": "<i>暂无</i>" ,"render":function(data,type,full,meta){
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }
...
<script id="carTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            <?php if (in_array("/index.php/Admin/Car/editCar",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="viewCar" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-print"></i> 查看 / 修改 </a>
            </li>
            <?php }?>
            <?php if (in_array("/index.php/Admin/Car/delCar",$_SESSION['allUrls'])){?>
            <li>
