<?php /* Smarty version Smarty-3.1.6, created on 2018-10-10 10:25:57
         compiled from "/var/www/yxcarnew/Admin/View/Index/index.html" */ ?>
<?php /*%%SmartyHeaderCode:11053274845bbd6335ea8fc6-10347356%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d550d1157dfd524cddc9910cdafd77f6d1af7d4' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Index/index.html',
      1 => 1537240640,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11053274845bbd6335ea8fc6-10347356',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbd6335f2414',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbd6335f2414')) {function content_5bbd6335f2414($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
/images/icon/geren.png" title="用户管理" ></span><span class="text">用户管理</span></li>
		...
		<li text="数据统计" icon="<?php echo @PUBLIC_URL;?>
/images/icon/tongji.png" path="/index.php/Admin/Report/byCompany" data-property="{ title:'数据统计',minimize:'true',maximize:'false',target:'iframe',multiple:'false' }" data-style="[{ name:'left',value:'0px' },{ name:'top',value:'0px' }]" ><span class="icon"><span class="icon"><img src="<?php echo @PUBLIC_URL;?>
/images/icon/tongji.png" title="数据报表" ></span><span class="text">数据报表</span></li>
