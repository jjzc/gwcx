<?php /* Smarty version Smarty-3.1.6, created on 2018-09-10 16:57:18
         compiled from "E:/PhpStorm/yxcar/Admin/View\Travel\viewTravel.html" */ ?>
<?php /*%%SmartyHeaderCode:206315b9631ee7f8b95-87818946%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '74d3801f24c4d59a677a157517886fe7f559011a' => 
    array (
      0 => 'E:/PhpStorm/yxcar/Admin/View\\Travel\\viewTravel.html',
      1 => 1534319692,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '206315b9631ee7f8b95-87818946',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b9631eead8dc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b9631eead8dc')) {function content_5b9631eead8dc($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\PhpStorm\\yxcar\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
" <?php if ($_smarty_tpl->tpl_vars['r']->value['user_name']==$_smarty_tpl->tpl_vars['use_user']->value['user_name']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['r']->value['user_name'];?>
...
"></td>
                            ...
                            <td>
                                <!-- 只有状态为7时才能够修改 -->
                                <?php if ($_smarty_tpl->tpl_vars['travel']->value['state']==7){?>
...
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>-->
                                <!--&lt;!&ndash; <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['travel']->value['driver_id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['driver_name'];?>
<?php echo $_smarty_tpl->tpl_vars['v']->value['driver_phone'];?>
</option> &ndash;&gt;-->
                                <!--<?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['travel']->value['car_id']){?><?php echo $_smarty_tpl->tpl_vars['v']->value['car_num'];?>
<?php }?>-->
                                <!--<?php } ?>-->
...
">元，出行服务费<input type="text" name="service_charge"  class="form-control"  value="<?php echo $_smarty_tpl->tpl_vars['travel']->value['service_charge'];?>
">元，司机住宿补贴<input type="text" name="driver_cost"  class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['travel']->value['driver_cost'];?>
...
?>-->
                <!--    <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['v']->value['company_name']==$_smarty_tpl->tpl_vars['company']->value['company_name']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['company_name'];?>
</option>-->
                <!--   <?php } ?>-->
                <!--   </select>-->
            </td>
...
元，出行服务费<?php echo $_smarty_tpl->tpl_vars['travel']->value['service_charge'];?>
