<?php /* Smarty version Smarty-3.1.6, created on 2019-01-03 19:40:49
         compiled from "D:/xampp/htdocs/Admin/View\Index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:212525b95c8315cb3d1-07736415%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a2ebd9d99dff74c1a9cafa29815fd1d7a549b60a' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Index\\index.html',
      1 => 1545270337,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '212525b95c8315cb3d1-07736415',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5b95c8316bd71',
  'variables' => 
  array (
    'isHavaCxManage' => 0,
    'cxUrl' => 0,
...
<?php if ($_valid && !is_callable('content_5b95c8316bd71')) {function content_5b95c8316bd71($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
/images/icon/sjtj.png" path="/index.php/Admin/Statistics/byCompany" data-property="{ title:'数据统计',minimize:'true',maximize:'false',target:'iframe',multiple:'false' }" data-style="[{ name:'left',value:'0px' },{ name:'top',value:'0px' }]" ><span class="icon"><span class="icon"><img src="<?php echo @PUBLIC_URL;?>
/images/icon/sjtj.png" title="数据统计" ></span><span class="text">数据统计</span></li>
        <?php }?>
...
/images/icon/geren.png" title="用户管理" ></span><span class="text">用户管理</span></li>
        ...
        <?php if (in_array("/index.php/Admin/Report/byCompany",$_SESSION['allUrls'])){?>
		<li text="数据报表" icon="<?php echo @PUBLIC_URL;?>
/images/icon/sjbb.png" path="/index.php/Admin/Report/byCompany" data-property="{ title:'数据统计',minimize:'true',maximize:'false',target:'iframe',multiple:'false' }" data-style="[{ name:'left',value:'0px' },{ name:'top',value:'0px' }]" ><span class="icon"><span class="icon"><img src="<?php echo @PUBLIC_URL;?>
/images/icon/sjbb.png" title="数据报表" ></span><span class="text">数据报表</span></li>
        <?php }?>


        <?php if (in_array("/index.php/Admin/Log/logList",$_SESSION['allUrls'])){?>
        <li text="操作日志" icon="<?php echo @PUBLIC_URL;?>
/images/icon/czrz.png" path="/index.php/Admin/Log/logList" data-property="{ title:'操作日志',minimize:'true',maximize:'false',target:'iframe',multiple:'false' }" data-style="[{ name:'left',value:'0px' },{ name:'top',value:'0px' }]" ><span class="icon"><span class="icon"><img src="<?php echo @PUBLIC_URL;?>
/images/icon/czrz.png" title="操作日志" ></span><span class="text">操作日志</span></li>
        <?php }?>

        <?php if (in_array("/index.php/Admin/Finance",$_SESSION['allUrls'])){?>
        <li text="费用管理" icon="<?php echo @PUBLIC_URL;?>
/images/icon/finance.png" path="/index.php/Admin/Finance/washRecord" data-property="{ title:'费用管理',minimize:'true',maximize:'false',target:'iframe',multiple:'false' }" data-style="[{ name:'left',value:'0px' },{ name:'top',value:'0px' }]" ><span class="icon"><span class="icon"><img src="<?php echo @PUBLIC_URL;?>
/images/icon/finance.png" title="费用管理" ></span><span class="text">费用管理</span></li>
        <?php }?>
