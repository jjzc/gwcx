<?php /* Smarty version Smarty-3.1.6, created on 2018-10-12 08:04:13
         compiled from "/var/www/yxcarnew/Admin/View/Driver/allDrivers.html" */ ?>
<?php /*%%SmartyHeaderCode:16827358645bbfe4fd499942-76948229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4573756d563ba7dd97c20c25ce9888a947e946da' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Driver/allDrivers.html',
      1 => 1534153866,
      2 => 'file',
    ),
    'af9423f83b89a7fc9ff3692be103970ac781276d' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Driver/template.html',
      1 => 1529924416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16827358645bbfe4fd499942-76948229',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbfe4fd5f969',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbfe4fd5f969')) {function content_5bbfe4fd5f969($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
...
<body class="page-sidebar-closed-hide-logo page-content-white">
            ...
            <div class="page-sidebar-wrapper">
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['driverLeft']->value!=null){?>
 ...
 $_from = $_smarty_tpl->tpl_vars['driverLeft']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部司机</span>
                                </div>
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php if (in_array("/index.php/Admin/Driver/addDriver",$_SESSION['allUrls'])){?>
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddDriver()"> 新增司机
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="allDrivers">
                                    <thead>
                                    <tr>
                                        <th style="padding-left: 0;padding-right: 0;text-align: center; width: 20px;"></th>
                                        <th class="all">姓名</th>
                                        <th class="all">联系电话</th>
                                        <th class="all">委托管理部门</th>
                                        <th class="all">身份证号码</th>
                                        <th class="all">准驾类型</th>
                                        <th class="all">入职时间</th>
                                        <th class="all">出行总数</th>
                                        <th class="all">出行总里程数</th>
                                        <th class="all">是否定向</th>
                                        <th class="all">状态</th>
                                        <th class="all" width="40">操作</th>

                                        <!--隐藏内容-->
                                        <th class="none">驾照到期</th>
                                        <th class="none">合同开始</th>
                                        <th class="none">合同结束</th>
                                        <th class="none">地址</th>
                                        <th class="none">备注</th>
                                    </tr>
                                    </thead>
...
<script>
        ...
        var initTableAllDrivers = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "driver_phone","defaultContent": "<i>暂无</i>" },
                    { "data": "department","defaultContent": "<i>暂无</i>" },
                    { "data": "driver_idcard" ,"defaultContent": "<i>暂无</i>"},
                    { "data": "lic_type","defaultContent": "<i>暂无</i>" },
                    { "data": "induction_time","defaultContent": "<i>暂无</i>","render":function(data,type,full,meta){
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }

                        } },
                    { "data": "count","defaultContent": "<i>暂无</i>","orderable":false },
                    { "data": "mileagecount","defaultContent": "<i>暂无</i>","orderable":false },

                    { "data": "is_dx","defaultContent": "<i>暂无</i>" ,"render":function(val,type,full,meta){
                            if(val=="1"){
                                return "<span style='color: #ff0000;'>定向</span>";
                            }else{
                                return "非定向"
                            }
                    ...
                    { "data": "state","defaultContent": "<i>暂无</i>" ,"render":function(val,type,full,meta){
                            if(val=="-1"){
                                return "离职";
                            }
                            if(val=="0"){
                    ...
                    { "data": "driver_lic_time","defaultContent": "<i>暂无</i>","render":function(data,type,full,meta){
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }

                        } },
                    { "data": "contract_start_time","defaultContent": "<i>暂无</i>","render":function(data,type,full,meta){
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }

                        } },
                    { "data": "contract_end_time","defaultContent": "<i>暂无</i>","render":function(data,type,full,meta){
                            if(data!=""&&data!=null){
                                return new Date(data*1000).format("yyyy-MM-dd");
                            }

                        } },
                    { "data": "address","defaultContent": "<i>暂无</i>" },
                    { "data": "remarks","defaultContent": "<i>暂无</i>" }
                ],
                "columnDefs": [
    ...
    function openAddDriver(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/Driver/addDriver'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewDriver', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Driver/editDriver/id/'+id
            });
        })


        //注册删除车辆事件
        $('#allDrivers tbody').on( 'click', 'td .delDriver', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/Driver/delDriver.html",
                            {
                                id:driverid
                            },
                            function(data){
...
<script id="driverTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            <?php if (in_array("/index.php/Admin/Driver/editDriver",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="viewDriver" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-print"></i> 查看 / 修改 </a>
            </li>
            <?php }?>
            <?php if (in_array("/index.php/Admin/Driver/delDriver",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="delDriver" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-file-pdf-o"></i> 删除司机 </a>
            </li>
            <?php }?>
        </ul>
    </div>
