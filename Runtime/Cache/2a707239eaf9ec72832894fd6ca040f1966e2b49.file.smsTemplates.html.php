<?php /* Smarty version Smarty-3.1.6, created on 2018-08-09 10:35:02
         compiled from "E:/PhpStorm/yxcar/Admin/View\TravelSet\smsTemplates.html" */ ?>
<?php /*%%SmartyHeaderCode:170295b6ba85678dd34-46044987%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a707239eaf9ec72832894fd6ca040f1966e2b49' => 
    array (
      0 => 'E:/PhpStorm/yxcar/Admin/View\\TravelSet\\smsTemplates.html',
      1 => 1528214088,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '170295b6ba85678dd34-46044987',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5b6ba8568ffb9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b6ba8568ffb9')) {function content_5b6ba8568ffb9($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部短信模板</span>
                                </div>
                                <div class="tools">
                                    <!--<div class="table-toolbar">-->
                                        <!--<div class="row">-->
                                            <!--<div class="col-md-6">-->
                                                <!--<div class="btn-group">-->
                                                    <!--<button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCar()"> 新增支付方式-->
...
<script>
    var TableDatatablesResponsive = function () {
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    { "data": "sms_name","defaultContent": "<i>暂无</i>" },
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/TravelSet/addPayType'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/TravelSet/editSmsTemplate/id/'+id
            });
        })
