<?php /* Smarty version Smarty-3.1.6, created on 2018-10-12 14:40:12
         compiled from "D:/xampp/htdocs/Admin/View\TravelSet\repairShop.html" */ ?>
<?php /*%%SmartyHeaderCode:135725bc041cce48cd7-63492899%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a66a3050379d5d36b463f452c35d62f3e19bf7c' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\TravelSet\\repairShop.html',
      1 => 1537240823,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '135725bc041cce48cd7-63492899',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bc041cd16026',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc041cd16026')) {function content_5bc041cd16026($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部车辆维修服务单位</span>
                                </div>
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCar()"> 新增服务单位
...
<script>
    var TableDatatablesResponsive = function () {
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columnDefs": [
                    { "orderable": true, "targets": 0 }//禁用第一列排序功能
                ],
                buttons: [],
                "language": language,
                "order": [
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/TravelSet/addRepairShop'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/TravelSet/editRepairShop/id/'+id
            });
        })
        ...
        $('#allCars tbody').on( 'click', 'td .delCar', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/TravelSet/delRepairShopDo.html",
                            {
                                id:carId
                            },
                            function(data){
...
<script id="carTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            ...
            <li>
                <a href="javascript:;" class="delCar" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-file-pdf-o"></i> 删除 </a>
            </li>
        </ul>
    </div>
</script>
