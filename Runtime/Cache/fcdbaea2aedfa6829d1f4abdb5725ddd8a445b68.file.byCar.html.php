<?php /* Smarty version Smarty-3.1.6, created on 2018-12-04 12:42:12
         compiled from "D:/xampp/htdocs/Admin/View\Report\byCar.html" */ ?>
<?php /*%%SmartyHeaderCode:251045b99ce328c0065-48912064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fcdbaea2aedfa6829d1f4abdb5725ddd8a445b68' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Report\\byCar.html',
      1 => 1543831524,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '251045b99ce328c0065-48912064',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5b99ce32b7b48',
  'variables' => 
  array (
    'startTime' => 0,
    'endTime' => 0,
...
<?php if ($_valid && !is_callable('content_5b99ce32b7b48')) {function content_5b99ce32b7b48($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
...
" <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['carname']->value){?>selected<?php }?> ><?php echo $_smarty_tpl->tpl_vars['v']->value['car_num'];?>
</option>
                                            <?php } ?>
                                        </select>
                                    </div>
...
" <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['companyname']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['company_name'];?>
                                    ...
                                    <div class="form-group" style="width: 160px; float: left; margin-right: 8px;">
                                        <select name="type" class="form-control"  id="type">
                                            ...
                                            <option value="2" <?php if ($_smarty_tpl->tpl_vars['type']->value==2){?>selected<?php }?>>出行明细报表</option>
                                        </select>
                                    </div>
                            ...
                            <div class="portlet-body">
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                                    ...
                                    <tr>
                                        <td height="30" colspan="17" style="font-size:16px; text-align:center; line-height:30px;">开起始时间：<?php echo $_smarty_tpl->tpl_vars['startTime']->value;?>
...
?>
                                    ...
                                    <tr class="trrrrr">
                                        <td nowrap><?php echo $_smarty_tpl->tpl_vars['v']->value['car_num'];?>
</td>
                                        ...
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['tingcheCount'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['zhushuCount'];?>
</td>
                                        ...
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['xiche'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['weixiu'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['jiayou'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['nianjian'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['xiaoji'];?>
</td>
                                        <td nowrap></td>
                                    </tr>
                                    <?php }?>
                                    ...
                                    <tr class="trrrrr">
                                        ...
                                        <td><?php echo $_smarty_tpl->tpl_vars['hj']->value['tingcheCount'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['hj']->value['zhushuCount'];?>
</td>
                                        ...
                                        <td><?php echo $_smarty_tpl->tpl_vars['hj']->value['xiche'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['hj']->value['weixiu'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['hj']->value['jiayou'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['hj']->value['nianjian'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['hj']->value['xiaoji'];?>
</td>
                            ...
                            <div class="portlet-body">
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                                    ...
                                    <tr>
                                        <td height="30" colspan="14" style="font-size:16px; text-align:center; line-height:30px;">开起始时间：<?php echo $_smarty_tpl->tpl_vars['startTime']->value;?>
&nbsp;&nbsp;&nbsp;&nbsp;截至时间：<?php echo $_smarty_tpl->tpl_vars['endTime']->value;?>
&nbsp;&nbsp;&nbsp;&nbsp;金额单位：元</td>
                                    </tr>
                                    <tr style="text-align:center; height:30px; line-height:30px;">
                                    ...
                                    <?php $_smarty_tpl->tpl_vars['mileagenum'] = new Smarty_variable(0, null, 0);?>
                                   <?php $_smarty_tpl->tpl_vars['fees_sumnum'] = new Smarty_variable(0, null, 0);?>
                                   <?php $_smarty_tpl->tpl_vars['service_chargenum'] = new Smarty_variable(0, null, 0);?>
                                   <?php $_smarty_tpl->tpl_vars['costnum'] = new Smarty_variable(0, null, 0);?>
                                   <?php $_smarty_tpl->tpl_vars['totle_ratenum'] = new Smarty_variable(0, null, 0);?>
...
?>
                                    <tr class="trrrrr">
                                        ...
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['serial_number'];?>
</td>
...
<?php $_smarty_tpl->tpl_vars['mileagenum'] = new Smarty_variable($_smarty_tpl->tpl_vars['mileagenum']->value+$_smarty_tpl->tpl_vars['v']->value['mileage'], null, 0);?></td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['fees_sum'];?>
<?php $_smarty_tpl->tpl_vars['fees_sumnum'] = new Smarty_variable($_smarty_tpl->tpl_vars['fees_sumnum']->value+$_smarty_tpl->tpl_vars['v']->value['fees_sum'], null, 0);?></td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['service_charge'];?>
<?php $_smarty_tpl->tpl_vars['service_chargenum'] = new Smarty_variable($_smarty_tpl->tpl_vars['service_chargenum']->value+$_smarty_tpl->tpl_vars['v']->value['service_charge'], null, 0);?></td>
                                        <td>0</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['else_cost'];?>
<?php $_smarty_tpl->tpl_vars['costnum'] = new Smarty_variable($_smarty_tpl->tpl_vars['costnum']->value+$_smarty_tpl->tpl_vars['v']->value['else_cost'], null, 0);?></td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['totle_rate'];?>
<?php $_smarty_tpl->tpl_vars['totle_ratenum'] = new Smarty_variable($_smarty_tpl->tpl_vars['totle_ratenum']->value+$_smarty_tpl->tpl_vars['v']->value['totle_rate'], null, 0);?></td>
                                        <td nowrap></td>
                                    </tr>
                                    <?php } ?>
                                    <tr class="trrrrr">
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['mileagenum']->value;?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['fees_sumnum']->value;?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['service_chargenum']->value;?>
</td>
                                        <td>0</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['costnum']->value;?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['totle_ratenum']->value;?>
</td>
                                        <td nowrap></td>
                                    </tr>
