<?php /* Smarty version Smarty-3.1.6, created on 2018-10-10 11:53:16
         compiled from "/var/www/yxcarnew/Admin/View/Company/allCompanys.html" */ ?>
<?php /*%%SmartyHeaderCode:18039407715bbd77ac0345e9-05098753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f57c15dd5cd8e1b112cc695ae4304142425cf21a' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Company/allCompanys.html',
      1 => 1537240587,
      2 => 'file',
    ),
    'df34ebaaa7ce4ee2f934d1f5dca40916be86bcac' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Company/template.html',
      1 => 1529901558,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18039407715bbd77ac0345e9-05098753',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbd77ac15ae0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbd77ac15ae0')) {function content_5bbd77ac15ae0($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部单位</span>
                                </div>
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php if (in_array("/index.php/Admin/Company/addCompany",$_SESSION['allUrls'])){?>
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddDriver()"> 新增单位
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="allCompanys">
                                    ...
                                    <tr>
                                        ...
                                        <th class="all">管理员手机</th>
                                        <th class="all">管理员姓名</th>
                                        <th class="all">单位所属机构</th>
                                        <th class="all">定向司机</th>
                                        <th class="all">定向车辆</th>
...
<script>
        ...
        var initTableAllDrivers = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "manager_user_phone" ,"defaultContent": "<i>暂无</i>","orderable":false},
                    { "data": "manager_user_name","defaultContent": "<i>暂无</i>","orderable":false },
                    { "data": "company_superior","defaultContent": "<i>暂无</i>" },

                    { "data": "driver_name","defaultContent": "<i> </i>","orderable":false },
                    { "data": "car_num","defaultContent": "<i> </i>" ,"orderable":false},
    ...
    function openAddDriver(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/Company/addCompany'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewDriver', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Company/editCompany/id/'+id
            });
        })
        ...
        $('#allCompanys tbody').on( 'click', 'td .delDriver', function () {
            ...
            swal({
                    title: "确定删除此单位吗？此操作同时将删除单位下的所有用户",
                    text: "",
                    type: "info",
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/Company/delCompany.html",
                            {
                                id:driverid
                            },
                            function(data){
...
<script id="driverTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            <?php if (in_array("/index.php/Admin/Company/editCompany",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="viewDriver" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-print"></i> 查看 / 修改 </a>
            </li>
            <?php }?>
            <?php if (in_array("/index.php/Admin/Company/delCompany",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="delDriver" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-file-pdf-o"></i> 删除单位 </a>
            </li>
            <?php }?>
        </ul>
    </div>
