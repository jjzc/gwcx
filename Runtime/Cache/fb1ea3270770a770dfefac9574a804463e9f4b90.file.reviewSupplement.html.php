<?php /* Smarty version Smarty-3.1.6, created on 2018-10-10 16:38:10
         compiled from "/var/www/yxcarnew/Admin/View/Travel/reviewSupplement.html" */ ?>
<?php /*%%SmartyHeaderCode:14930294125bbdba72f1dd46-05309273%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb1ea3270770a770dfefac9574a804463e9f4b90' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Travel/reviewSupplement.html',
      1 => 1531462130,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '14930294125bbdba72f1dd46-05309273',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbdba7310bf8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbdba7310bf8')) {function content_5bbdba7310bf8($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">补单审核</span>
                                </div>
                                <div class="tools">
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewTravel', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Travel/viewSupplement/id/'+TravelId
            });
        })
        ...
        //注册审核通过点击事件
        $('tbody').on( 'click', 'td .agreeTravel', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/Travel/reviewSupplementDo.html",
                            {
                                id:TravelId,
                                type:1
                            },
        ...
        //注册驳回点击事件
        $('tbody').on( 'click', 'td .disagreeTravel', function () {
            //alert($(this).attr("data-id"));
            var TravelId=$(this).attr("data-id");
            swal({
                    title: "确定驳回此出行申请吗？",
...
<script id="reviewTravel" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            ...
            <li>
                <a href="javascript:;" class="disagreeTravel" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-file-pdf-o"></i> 审核驳回 </a>
            </li>
