<?php /* Smarty version Smarty-3.1.6, created on 2018-10-11 10:41:45
         compiled from "/var/www/yxcarnew/Admin/View/Statistics/byCompany.html" */ ?>
<?php /*%%SmartyHeaderCode:8223621895bbeb869181358-25693604%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d9468f203ae1e3dfce9705ec2aadaffde639550' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Statistics/byCompany.html',
      1 => 1530157550,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8223621895bbeb869181358-25693604',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbeb86929832',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbeb86929832')) {function content_5bbeb86929832($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                    ...
                    <li class="nav-item start active open">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item start  active open">
                                <a href="/index.php/Admin/Statistics/byCompany" class="nav-link ">
                                    <i class="icon-graph"></i>
                                    <span class="title">单位数据统计</span>
                                    <!--<span class="badge badge-success">1</span>-->
                                </a>
                            </li>
                            <li class="nav-item start ">
                                <a href="/index.php/Admin/Statistics/byCar" class="nav-link ">
                                    <i class="icon-graph"></i>
                                    <span class="title">车辆数据统计</span>
                                    <!--<span class="badge badge-danger">5</span>-->
                                </a>
                            </li>
                            <li class="nav-item start ">
                                <a href="/index.php/Admin/Statistics/byDriver" class="nav-link ">
                                    <i class="icon-graph"></i>
                                    <span class="title">司机数据统计</span>
                                    <!--<span class="badge badge-danger">5</span>-->
                                </a>
                            </li>
                            <li class="nav-item start ">
                                <a href="/index.php/Admin/Statistics/byUser" class="nav-link ">
                                    <i class="icon-graph"></i>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">单位数据统计</span>
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <form action="/index.php/Admin/Statistics/byCompanyToExcel" method="post" target="_blank">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="allCars">
                                    ...
                                    <tr>
                                        ...
                                        <th class="all">单位名称</th>
                                        <th class="all">出行里程</th>
                                        <th class="all">出行费用</th>
                                        <th class="all">申请次数</th>
                                        <th class="all">待单位审核</th>
                                        <th class="all">待中心审核</th>

                                        <th class="all">待派车</th>
                                        <th class="all">已派车</th>

                                        <th class="all">待出车</th>
                                        <th class="all">执行任务中</th>
                                        <th class="all">已完成</th>
                                        ...
                                        <!--隐藏内容-->
                                        <th class="none">单位驳回</th>
                                        <th class="none">中心驳回</th>
                                        <th class="none">派车审核驳回</th>
                                        <th class="none">申请取消中</th>
                                        <th class="none">取消成功</th>
...
<script>
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "company_name","defaultContent": "<i>暂无</i>" },
                    { "data": "companyMileageCount","defaultContent": "<i>0</i>" },
                    { "data": "companyRateCount","defaultContent": "<i>0</i>" },
                    { "data": "companyCount","defaultContent": "<i>0</i>" },

                    { "data": "state0","defaultContent": "<i>0</i>" },
                    { "data": "state1","defaultContent": "<i>0</i>" },

                    { "data": "state3","defaultContent": "<i>0</i>" },
                    { "data": "state5","defaultContent": "<i>0</i>" },

                    { "data": "state6","defaultContent": "<i>0</i>" },
                    { "data": "state8","defaultContent": "<i>0</i>" },
                    { "data": "state9","defaultContent": "<i>0</i>" },

                    { "data": "company_name","defaultContent": "<i>暂无</i>","orderable":false ,"render":function (data,type,full,meta) {
                            var html = template(document.getElementById('viewTools').innerHTML, full);
                            return html;
                        }},

                    { "data": "state2","defaultContent": "<i>0</i>" },
                    { "data": "state4","defaultContent": "<i>0</i>" },
                    { "data": "state7","defaultContent": "<i>0</i>" },
                    { "data": "state10","defaultContent": "<i>0</i>" },
                    { "data": "state11","defaultContent": "<i>0</i>" },
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            //加载模态框，直接模态框操作
            var startTime=$("#startTime").val();
            if(isE(startTime)){ startTime="2014-01-01"; }
            //获取结束时间
            var endTime=$("#endTime").val();
            if(isE(endTime)){ endTime="2025-01-01"; }
            layer.open({
                type: 2,
                title:"查看出行列表",
                area: ['1150px', '850px'],
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Statistics/viewTravelList/company/'+id+'/startTime/'+startTime+'/endTime/'+endTime
            });
        })
