<?php /* Smarty version Smarty-3.1.6, created on 2018-12-19 16:24:51
         compiled from "D:/xampp/htdocs/Admin/View\Car\washRecord.html" */ ?>
<?php /*%%SmartyHeaderCode:56535bbf093f6b3ed5-67835840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89025704f3ca520383ab74e0ea7277d1974dda4a' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Car\\washRecord.html',
      1 => 1545189165,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '56535bbf093f6b3ed5-67835840',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bbf093fedde3',
  'variables' => 
  array (
    'carLeft1' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_5bbf093fedde3')) {function content_5bbf093fedde3($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>公务用车</title>
                                ...
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php if (in_array("/index.php/Admin/Car/addWashRecord",$_SESSION['allUrls'])){?>
...
<script id="carTools" type="text/html">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu pull-right">
            <?php if (in_array("/index.php/Admin/Car/editWashRecord",$_SESSION['allUrls'])){?>
            <li>
                <a href="javascript:;" class="editWashRecord" data-id="<<?php ?>%=id%<?php ?>>"><i class="fa fa-print"></i> 查看 / 修改 </a>
            </li>
            <?php }?>

            <?php if (in_array("/index.php/Admin/Car/delWashRecord",$_SESSION['allUrls'])){?>
            <li>
