<?php /* Smarty version Smarty-3.1.6, created on 2018-10-12 14:40:16
         compiled from "D:/xampp/htdocs/Admin/View\TravelSet\oilShop.html" */ ?>
<?php /*%%SmartyHeaderCode:156505bc041d0204e43-79504477%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '982506247f531b0e6bf10a2dbbb951169fab81e1' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\TravelSet\\oilShop.html',
      1 => 1537240841,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156505bc041d0204e43-79504477',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bc041d08cf46',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc041d08cf46')) {function content_5bc041d08cf46($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部加油服务单位</span>
                                </div>
                                <div class="tools">
...
<script>
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/TravelSet/addOilShop'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/TravelSet/editOilShop/id/'+id
            });
        })
        ...
        $('#allCars tbody').on( 'click', 'td .delCar', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/TravelSet/delOilShopDo.html",
                            {
                                id:carId
                            },
                            function(data){
