<?php /* Smarty version Smarty-3.1.6, created on 2018-11-23 18:38:09
         compiled from "D:/xampp/htdocs/Admin/View\Car\addCarType.html" */ ?>
<?php /*%%SmartyHeaderCode:77165bf7d8914ac8b3-04862367%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8173f02d9d7b8647edea0729ec7a531b3e67016' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Car\\addCarType.html',
      1 => 1527517632,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '77165bf7d8914ac8b3-04862367',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bf7d89160450',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bf7d89160450')) {function content_5bf7d89160450($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>新增车辆</title>
        ...
        <div class="row">
            <div class="portlet light" style="padding: 0px 35px 20px 35px;">
                <div class="portlet-body form">
                    <form class="form-horizontal" role="form" action="/index.php/Admin/Car/addCarTypeDo" method="post" id="addCarTypeForm">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">车辆类型名称</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control input-inline input-medium" placeholder="车辆类型名称" name="type_name" id="type_name">
...
<script>
    ...
    $("#addCarTypeForm").submit(function () {
        ...
        if(isE($("#type_name").val())){ toastr.error('车辆类型名称不得为空！');  $("#type_name").focus();return false; }
