<?php /* Smarty version Smarty-3.1.6, created on 2018-10-18 08:33:46
         compiled from "/var/www/yxcarnew/Admin/View/Company/addCompany.html" */ ?>
<?php /*%%SmartyHeaderCode:1628800245bc7d4ea501782-88026970%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ac7bb0d4f1cd7cdc25692099bd3962aea8c4702' => 
    array (
      0 => '/var/www/yxcarnew/Admin/View/Company/addCompany.html',
      1 => 1530681162,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1628800245bc7d4ea501782-88026970',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bc7d4ea573c9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc7d4ea573c9')) {function content_5bc7d4ea573c9($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>新增单位</title>
    ...
    <div class="page-content">
        <div>
            <div class="portlet light">
                ...
                <form class="form-horizontal" role="form" action="/index.php/Admin/Company/addCompanyDo" method="post" id="addDriverForm">
                    <div class="form-body">

                        <div class="form-group col-md-6">
                            <label class="col-md-4 control-label">单位名称</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="单位名称" name="company_name" id="company_name">
                                <span style="color: #FF0000;">*</span>
                            </div>
                        </div>

                        <div class="form-group col-md-6">
                            <label class="col-md-4 control-label">管理员手机号</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="单位管理员手机号" name="user_phone" id="user_phone">
                                <span style="color: #FF0000;">*</span>
                            </div>
                        </div>

                        <div class="form-group col-md-6">
                            <label class="col-md-4 control-label">管理员姓名</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="单位管理员姓名" name="user_name" id="user_name">
                                <span style="color: #FF0000;">*</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="单位地址" name="company_address" id="company_address">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="单位电话" name="company_phone" id="company_phone">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control input-inline input-medium" placeholder="单位所属机构"  name="company_superior" id="company_superior">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <a class="form-control input-inline input-medium" style="border: none;"></a>
                            </div>
                        </div>
...
<script>
    ...
    $("#addDriverForm").submit(function () {
        ...
        //定向司机选择时，必须定向司机与车辆同时有值
        if(($("#dx_car").val()==0&&$("#dx_driver").val()!=0) || ($("#dx_car").val()!=0&&$("#dx_driver").val()==0)){
            //
            toastr.error('定向司机与定向车辆必须同时选择！'); return false;
        }
