<?php /* Smarty version Smarty-3.1.6, created on 2018-10-11 15:39:37
         compiled from "D:/xampp/htdocs/Admin/View\TravelSet\subsidyType.html" */ ?>
<?php /*%%SmartyHeaderCode:307225bbefe3948b836-70278605%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '73cd3109ffd2b3f250c6472d7ae9dc878524c492' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\TravelSet\\subsidyType.html',
      1 => 1536632718,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '307225bbefe3948b836-70278605',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bbefe39c0997',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbefe39c0997')) {function content_5bbefe39c0997($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">全部补贴类型</span>
                                </div>
                                <div class="tools">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold green" onclick="openAddCar()"> 新增补贴类型
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="allCars">
                                    <thead>
                                    <tr>
                                        <th class="all">补贴类型名称</th>
                                        <th class="all">补贴价格（天）</th>
...
<script>
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "price","defaultContent": "<i>暂无</i>" },
    ...
    function openAddCar(){
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/index.php/Admin/TravelSet/addSubsidyType'
        });
    }
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/TravelSet/editSubsidyType/id/'+id
            });
        })
        ...
        $('#allCars tbody').on( 'click', 'td .delCar', function () {
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        //此处进行审核操作AJAX
                        $.post("/index.php/Admin/TravelSet/delPayType.html",
                            {
                                id:carId
                            },
                            function(data){
