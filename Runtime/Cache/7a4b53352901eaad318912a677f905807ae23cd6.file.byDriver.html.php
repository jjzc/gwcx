<?php /* Smarty version Smarty-3.1.6, created on 2018-11-15 09:48:53
         compiled from "D:/xampp/htdocs/Admin/View\Statistics\byDriver.html" */ ?>
<?php /*%%SmartyHeaderCode:168595becd0856f9f55-58614313%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7a4b53352901eaad318912a677f905807ae23cd6' => 
    array (
      0 => 'D:/xampp/htdocs/Admin/View\\Statistics\\byDriver.html',
      1 => 1530157570,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '168595becd0856f9f55-58614313',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5becd085e35a0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5becd085e35a0')) {function content_5becd085e35a0($_smarty_tpl) {?><!DOCTYPE html>
                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <form action="/index.php/Admin/Statistics/byDriverToExcel" method="post" target="_blank">
        ...
        var initTableAllCars = function () {
            ...
            var oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "data": "mileagecount","defaultContent": "<i>0</i>" },
    ...
    jQuery(document).ready(function() {
        ...
        $('tbody').on( 'click', 'td .viewCar', function () {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/index.php/Admin/Statistics/viewTravelList/driver/'+id+'/startTime/'+startTime+'/endTime/'+endTime
            });
        })
