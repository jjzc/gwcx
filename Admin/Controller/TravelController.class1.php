...
class TravelController extends CommonController {
    ...
    public function getCenterReviewTravels(){
        //dump($_POST);
        //获取记录集总数
        $resCount=M("Travel")->where("state=1 and is_need_center_review=1 and is_del=0")->select();

        $res=M("Travel")->where("state=1 and is_need_center_review=1 and is_del=0")->limit($_POST["start"],$_POST["length"])->select();
    ...
    public function getWaitSendCarTravels(){
        //dump($_POST);
        //获取记录集总数
        $resCount=M("Travel")->where("state=3 and is_need_center_review=1 and is_del=0")->select();

        $res=M("Travel")->where("state=3 and is_need_center_review=1 and is_del=0")->limit($_POST["start"],$_POST["length"])->select();
    ...
    public function getWaitReviewSendCar(){
        $resCount=M("Travel")->where("state=5 and is_need_center_review=1 and is_del=0")->select();

        $res=M("Travel")->where("state=5 and is_need_center_review=1 and is_del=0")->limit($_POST["start"],$_POST["length"])->select();
    ...
    public function getWaitStartCarTravels(){
        //dump($_POST);
        //获取记录集总数
        $resCount=M("Travel")->where("state=6  and is_del=0")->select();

        $res=M("Travel")->where("state=6  and is_del=0")->limit($_POST["start"],$_POST["length"])->select();
    ...
    public function getWaitFinishTravels(){
        $resCount=M("Travel")->where("state=8 and is_del=0")->select();

        $res=M("Travel")->where("state=8 and is_del=0")->limit($_POST["start"],$_POST["length"])->select();
    ...
    public function getWaitChargingTravels(){
        $resCount=M("Travel")->where("is_need_settlement=1 and is_settlemented=0 and is_del=0 and state=9")->select();

        $res=M("Travel")->where("is_need_settlement=1 and is_settlemented=0 and is_del=0 and state=9")->limit($_POST["start"],$_POST["length"])->select();
...
//        $this->assign("car",$car_name);
    ...
    public function rk(){
        $res=httpF("http://192.168.1.112:8090/setting/apply/getVehicleTypeApply","","","GET");

        //$res='{"code": 200,"message": "success","success": false,"data": {"carType": [{"vehicleType": 1,"name": "经济型","seq": "1","seats": 4,"imagePath": "","memo": "专车-经济型","createBy": "admin","updateBy": "admin","updateTime": 1499327244000,"createTime": 1493476818000},{"vehicleType": 2,"name": "舒适型","seq": "2","seats": 4,"imagePath": "../assets/img/zhuanchecartype/picture2.png","memo": "","createBy": "admin","updateBy": "admin","updateTime": 1504756339000,"createTime": 1504756261000},{"vehicleType": 3,"name": "商务型","seq": "3","seats": 4,"imagePath": "../assets/img/zhuanchecartype/picture1.png","memo": "","createBy": "admin","updateBy": "admin","updateTime": null,"createTime": 1504756286000},{"vehicleType": 4,"name": "SUV型","seq": "4","seats": 4,"imagePath": "../assets/img/zhuanchecartype/picture1.png","memo": "","createBy": "admin","updateBy": "admin","updateTime": null,"createTime": 1504756313000},{"vehicleType": 5,"name": "七座商务","seq": "5","seats": 7,"imagePath": "../assets/img/zhuanchecartype/picture1.png","memo": "","createBy": "admin","updateBy": "admin","updateTime": 1515082252000,"createTime": 1504756330000},{"vehicleType": 6,"name": "豪华型","seq": "6","seats": 4,"imagePath": "../assets/img/zhuanchecartype/picture1.png","memo": "","createBy": "admin","updateBy": "admin","updateTime": null,"createTime": 1504756367000},{"vehicleType": 7,"name": "SUV舒适型","seq": "7","seats": 4,"imagePath": "../assets/img/zhuanchecartype/picture3.png","memo": "SUV舒适型","createBy": "admin","updateBy": "admin","updateTime": null,"createTime": 1514183083000},{"vehicleType": 8,"name": "SUV商务型","seq": "8","seats": 10,"imagePath": "../assets/img/zhuanchecartype/picture1.png","memo": "SUV商务型","createBy": "admin","updateBy": "admin","updateTime": 1515133730000,"createTime": 1514183219000}]}}';

        $res=json_decode($res,true);

        M("JjCarType")->where("id>0")->delete();

        for($i=0;$i<count($res["data"]["carType"])&&count($res["data"]["carType"])!=0;$i++){
            //echo $res["data"]["carType"][$i]["name"];
            $data["id"]=$res["data"]["carType"][$i]["vehicleType"];
            $data["type_name"]=$res["data"]["carType"][$i]["name"];
            M("JjCarType")->add($data);
        }
    ...
    public function sendCarToOtherDo(){
        ...
        //发送数据给创建订单服务器
        $res=httpF("http://192.168.1.112:8090/order/specialCar/createByTransport","",json_encode($data),"POST");
