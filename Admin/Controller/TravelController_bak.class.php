...
class TravelController extends CommonController {
    ...
    public function getWaitFinishTravels(){
        ...
        $res=M("Travel")->where("state=8 and is_del=0")->order("")->limit($_POST["start"],$_POST["length"])->select();
    ...
    public function sendCarReviewDo(){
        ...
        if($_POST["type"]==1){
            ...
            A("UserCenter")->logCreatWeb("派车审核通过，出行流水号： ".$travel["serial_number"]);
            ...
            A("UserCenter")->logCreatWeb("派车审核驳回，出行流水号： ".$travel["serial_number"]);
        }
...
//        }
    ...
    public function viewTravelTrack($id){
        ...
        $post_data['start_time'] = $travel["start_car_time"];
        ...
        $post_data['page_size'] = 5000;

        $res =  $this->request_post($url, $post_data);



        $this->assign("driverPoint",$res);

        //获取乘客轨迹
        $post_data['start_time'] = $travel["boarding_time"];
        $post_data['end_time'] = $travel["alighting_time"];

        $UserRes =  $this->request_post($url, $post_data);



        $this->assign("UserPoint",$UserRes);
...
//        $this->assign("car",$car_name);
    ...
    public function editTravelDo(){
        ...
        $travel=M("Travel")->find($_POST["idd"]);
...
//        $this->assign("car",$car_name);
    ...
    public function sendCarToOtherDo(){
        ...
        $sendData.="user_name=".$useUser["user_name"]."&";
